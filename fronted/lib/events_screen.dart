...
class FeedScreen extends StatefulWidget {
  ...
  const FeedScreen({Key key, this.user,this.postcategoryfeed}) : super(key: key);

  @override
  FeedScreenState createState() => FeedScreenState(user: user,postcategoryfeed: postcategoryfeed);
}

class FeedScreenState extends State<FeedScreen> {
  final User user;
  final String postcategoryfeed;
  FeedScreenState({Key key, this.posts,this.user,this.postcategoryfeed});
              ...
              IconButton(
                ...
                onPressed: () {
                  Navigator.push(
                    context ,
                    MaterialPageRoute(
                      builder: (_) => CreatePostScreen(user:user,category: 'event',
                      ),
                    ),
                  );
                },
      ...
      body: RefreshIndicator(
        ...
        child: FutureBuilder<List<Post>>(
          ...
          builder: (context, snapshot) {
            ...
            return snapshot.hasData ? PostsScreen(posts: snapshot.data,user:user)
                :
...
class PostsScreen extends StatefulWidget {
  ...
  const PostsScreen({Key key, this.user,this.posts,}) : super(key: key);

  @override
  PostsScreenState createState() => PostsScreenState(user: user,posts:posts);
}
...
class PostsScreenState extends State<PostsScreen> {
  ...
  PostsScreenState({Key key, this.posts, this.user});
  @override
  ...
  Widget build(BuildContext context) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        print(posts.length);
        return  posts[index].category == 'event' ? FutureBuilder<User>(
                                        ...
                                        child: Column(
                                          children: <Widget>[
                                            Container(
                                              ...
                                              child: Carousel(
                                                images: posts[index].images.map((post)=>post.carouselimages()).toList()
